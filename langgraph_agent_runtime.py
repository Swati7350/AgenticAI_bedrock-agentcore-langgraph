...
print("Region:", bedrock_client.meta.region_name)
print("Endpoint:", bedrock_client.meta.endpoint_url)
emb = BedrockEmbeddings(
    client=bedrock_client,
    model_id="amazon.titan-embed-text-v2:0"
)
print('Invoking BedrockEmbeddings -' ,len(emb.embed_query("hello world")))
...
def search_faq(query: str) -> str:
    ...
    print("DEBUG: search_faq - Tool called with query:", query)
...
def search_detailed_faq(query: str, num_results: int = 5) -> str:
    ...
    print("DEBUG: search_detailed_faq - Tool called with query:", query)
...
def reformulate_query(original_query: str, focus_aspect: str) -> str:
    ...
    print("DEBUG: reformulate_query - Tool called with query:")
...
#agentcore entrypoint - We should add this when we call it from bedrockagentcore
@app.entrypoint
